...
<div class="row">
    ...
    <div class="form login-form col-md-4 col-md-push-4">
        ...
        <p class="text-center">Unesite svoje korisničko ime i lozinku da bi ste pristupili administraciji:</p>
        ...
        <div class="">
            <?php echo $form->textField($model,'username', array('placeholder'=> "Korisničko ime",'class'=>'form-control', 'required' => true, 'autofocus' => true)); ?>
